jQuery(document).ready(function($){
    ...
    $('.wppm-progress-bar').each(function(){
        var $bar = $(this);
    ...
    $('.wppm-badge').each(function(){
        var $badge = $(this);
        var classes = $badge.attr('class').split(/\s+/);
        classes.forEach(function(cl){
            if(cl.indexOf('wppm-status-') === 0){
                switch(cl.replace('wppm-status-','')){
            ...
            if(cl.indexOf('wppm-priority-') === 0){
                switch(cl.replace('wppm-priority-','')){
